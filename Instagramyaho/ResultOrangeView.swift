    ...
    var body: some View {
        VStack{
            ...
            NavigationView{
                ScrollView {
                    Circle()
                        .fill(AngularGradient(gradient: Gradient(colors: [.white, .orange]), center: .topLeading, angle: .degrees(180+45)))
                        .frame(width:130, height:130)
                    HStack{
                        Text("트로피칼").font(.system(size:25, weight: .black))
                        Text("주황").font(.system(size:25, weight: .black))
...
struct ResultOrangeView_Previews: PreviewProvider {
